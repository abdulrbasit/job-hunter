...
def hunt(
    ...
    depth: str = typer.Option(
        ...
        "--depth",
        help=(
            "Reserved for future use. Adaptive hunt always escalates through its own "
            "fixed fast/deep/ATS passes per region regardless of this value."
        ),
    ),
    ...
    from_db_candidates: bool = typer.Option(
        False,
        "--from-db-candidates",
        help="Process pending company-hunt candidates from jobs.db (llm-api mode only)",
    ),
